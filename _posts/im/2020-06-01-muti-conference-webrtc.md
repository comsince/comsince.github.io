...
![image](/images/im/kurento-java-tutorial-1-helloworld-pipeline.png)
...
![image](/images/im/kurento-java-tutorial-1-helloworld-signaling.png)
...
* 信令服务器处理`joinRoom`消息,向群组中的用户广播有新的参与者加入.并且给新参数返回群组现有的成功名单
* 新的参与者会接收到现有的群组成员名单
